...
public class MealCreateCommandValidatorSpecs
{
    private readonly MealCreateCommandValidator validator = new();
    ...
    public void ShouldHaveValidationErrorIfNameHaveInvalidLength(
        string name)
    {
        var testResult = this.validator.TestValidate(new MealCreateCommand
        {
            Name = name,
        });

...
using static Domain.Restaurant.Models.ModelConstants.DayMeal;

public class DayMealCreateCommandValidatorSpecs
{
    private readonly DayMealCreateCommandValidator validator = new();
    ...
    public void ShouldHaveValidationErrorIfNameHaveInvalidLength(
        int totalNo)
    {
        var testResult = this.validator.TestValidate(new DayMealCreateCommand
        {
            TotalNo = totalNo,
        });

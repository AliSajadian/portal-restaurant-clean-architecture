...
public class JobPositionCreateCommandValidatorSpecs
{
    private readonly JobPositionCreateCommandValidator validator = new();
    ...
    public void ShouldHaveValidationErrorIfNameHaveInvalidLength(
        string name)
    {
        var testResult = this.validator.TestValidate(new JobPositionCreateCommand
        {
            Name = name,
        });

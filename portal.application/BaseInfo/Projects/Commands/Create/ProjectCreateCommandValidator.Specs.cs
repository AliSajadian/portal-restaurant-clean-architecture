...
public class ProjectCreateCommandValidatorSpecs
{
    private readonly ProjectCreateCommandValidator validator = new();
    ...
    public void ShouldHaveValidationErrorIfNameHaveInvalidLength(
        string name)
    {
        var testResult = this.validator.TestValidate(new ProjectCreateCommand
        {
            Name = name,
        });

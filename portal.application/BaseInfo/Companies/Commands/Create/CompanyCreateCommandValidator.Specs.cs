...
public class CompanyCreateCommandValidatorSpecs
{
    private readonly CompanyCreateCommandValidator validator = new();
    ...
    public void ShouldHaveValidationErrorIfNameHaveInvalidLength(
        string name)
    {
        var testResult = this.validator.TestValidate(new CompanyCreateCommand
        {
            Name = name,
        });
